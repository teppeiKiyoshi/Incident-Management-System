  ...
  return (
    <div>
      ...
      >
        ...
        <AccordionDetails>
          <Typography>
          You can send a follow-up question within your active incident report with no limits but shall consider only the scope of the latest filed report.
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion
      ...
      >
        ...
        <AccordionDetails>
          <Typography>
          Go to settings and choose Change Password button. Also, on the navigation bar, you can click on the account icon to access your account settings. There are quick links provided as well over the account icon dropdown menu.
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion
      ...
      >
        ...
        <AccordionDetails>
          <Typography>
          Click the forgot password, an email will be sent to you with the procedure of resetting your password. Important Note: Do not share any details to other users regarding your account for security reasons.
          </Typography>
        </AccordionDetails>
      </Accordion>
    </div>
